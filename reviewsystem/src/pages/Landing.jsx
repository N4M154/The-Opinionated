        ...
        <div className="relative container mx-auto px-4 py-32">
          <div className="max-w-3xl">
            ...
            <div className="ml-10 flex flex-col sm:flex-row gap-4 mb-16">
              <Link to="/signin">
                <button className="group relative rounded-full sm:rounded-full bg-black text-yellow-200 dark:bg-yellow-200 dark:text-black px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-2xl shadow-black/40 hover:shadow-black/60 ">
                  <span className="flex items-center gap-2">
                    Let&apos;s Go!
                    <PawPrint className="w-5 h-5 transition-transform group-hover:rotate-12" />
                  </span>
                  <div className="absolute inset-0 rounded-xl bg-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                </button>
              </Link>
            </div>
            <div className="ml-10 flex justify-left items-center space-x-8 opacity-60 form-fade-in">
              <div className="text-center group cursor-pointer hover:scale-120 transition-all duration-300">
      ...
      <section className="py-20 px-6 relative bg-yellow-50 dark:bg-[#181818]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            <div className="p-6 hover:scale-120 transition-all duration-300 cursor-pointer form-slide-in">
