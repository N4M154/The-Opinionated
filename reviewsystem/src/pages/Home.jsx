...
//               className="bg-yellow-200 text-black px-6 py-3 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
//             >
//               <NotebookPen className="w-6 h-6" />
//             </button>
//             <button
//               onClick={logout}
//               className="bg-black dark:bg-pink-50 dark:text-black text-white px-4 py-3 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
//             >
...
//         {/* Filters */}
//         <div className="glass rounded-2xl shadow-2xl p-6 mb-8 border border-white/20 transition-all duration-200 form-fade-in">
...
//                 className="px-3 py-2 bg-white/10 border border-white/20 rounded-xl text-black focus:outline-none focus:ring-2 focus:ring-violet-400 focus:border-transparent transition-all duration-200 backdrop-blur-sm input-focus"
//               >
...
//                 className="bg-yellow-200 text-black px-4 py-2 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
//               >
//                 Apply Filters
//               </button>
//             </div>
  ...
  "
      >
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10">
          <ArrowBigDownDash
            className="w-15 h-15 text-black dark:text-white animate-bounce icon-glow"
            onClick={RollDown}
          />
        </div>
      </section>

      <section ref={mainRef} className="relative z-10">
        {/* EXISTING CONTENT */}
        <div className="relative z-10 container mx-auto px-4 py-8">
          {/* Header */}
          <div className="flex items-center justify-between mb-8 form-slide-in">
          ...
          {/* Filters */}
          <div className="glass rounded-2xl shadow-2xl p-6 mb-8 border border-white/20 transition-all duration-200 form-fade-in">
            <h2 className="text-lg font-thin mb-4 text-black dark:text-white">
              Filter Reviews
            </h2>
            <div className="flex gap-4">
              <div>
