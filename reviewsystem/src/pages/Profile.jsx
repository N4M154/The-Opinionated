...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden py-12">
      ...
      <div
        className="absolute bottom-1/3 left-1/3 w-6 h-6 bg-red-300/30 rounded-full animate-float-particle"
      ...
      <div className="relative z-10 max-w-md mx-auto px-6 form-slide-in">
        <div className="glass rounded-3xl shadow-2xl p-8 border border-white/20 hover-lift form-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-thin text-white mb-2">Profile</h1>
          ...
          <div className="space-y-6">
            <div className="glass bg-white/10 rounded-xl p-4 border border-white/20 hover-lift">
              ...
              <p className="text-lg text-white font-thin">{userEmail}</p>
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-red-500 to-pink-600 text-white font-thin rounded-xl hover:from-red-600 hover:to-pink-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover-lift"
            >
              Logout
            </button>
          </div>
