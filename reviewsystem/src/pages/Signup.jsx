...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div
        className="absolute bottom-1/3 left-1/3 w-6 h-6 bg-pink-300/30 rounded-full animate-float-particle"
        ...
        <div className="glass rounded-3xl p-8 shadow-2xl hover-lift form-fade-in">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-thin rounded-xl hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
            >
              {isLoading ? (
          ...
          <div className="text-center mt-6">
            <p className="text-white/70">
              ...
              <a
                href="/login"
                className="text-purple-300 hover:text-white font-thin transition-colors duration-300 underline decoration-purple-300/50 hover:decoration-white"
              >
                Sign in here
              </a>
            </p>
