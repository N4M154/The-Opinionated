...
export default function ReviewCard({
  ...
  return (
    <>
      <div className="rounded-2xl p-6 border border-pink-300 dark:border-gray-400/40 hover-lift transition-all duration-200 relative h-full flex flex-col">
        {showDelete && (
          <button
      ...
      {showModal && (
        <div className="fixed inset-0 bg-pink-50/50 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 form-fade-in">
          <div className="rounded-3xl max-w-2xl w-full border border-white/20 shadow-xl">
            <div className="p-6">
